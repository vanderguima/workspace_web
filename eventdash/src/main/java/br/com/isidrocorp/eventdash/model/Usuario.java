...
public class Usuario {
	...
	@Column(name="email_usuario", length = 100, nullable = true, unique = true)
	...
	@Column(name = "senha_usuario", length = 30, nullable = false, unique = true)
	private String senha;
	
	@Column(name = "link_foto", length = 225, nullable = true)
